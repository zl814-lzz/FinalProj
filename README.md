...
By default, the script looks for the dataset in the project root:
...
- `recent_adoption_utilities.csv`: ranked utilities using recent model-year share as the recency indicator.
...
- `top_utilities_by_recent_adoption_share.svg`: visualization of utilities with the highest recent model-year share.
